%[text] # Pretrained AI Antennas for Design Space Exploration — Solution
%[text] Use pretrained AI surrogate models to instantly predict antenna performance metrics without full-wave simulation. In these exercises, you will use `AIAntenna` objects to design antennas and query performance.
%%
...
pAI = design(patchMicrostrip,5.8e9,ForAI=true)
%%
...
pAI = design(patchMicrostripCircular(Substrate=dielectric("FR4")),2.4e9,ForAI=true)
%%
%[text] Visualize the antenna geometry.
show(pAI)
%%
...
[hpbw,angles,plane] = beamwidth(pAI,2.4e9)
%%
...
pAI = design(horn,10e9,ForAI=true)
%%
%[text] Visualize the antenna geometry.
show(pAI)
%%
